...
function masonry(container, childs, columns) {
	const $container = document.querySelector(container);
	const $childs = document.querySelectorAll(childs);
	$container.classList.add('masonry1', `masonry--columns_${columns}`);
	...
	for(let i = 1; i <= columns; i++) {
	   ...
	   $item.classList.add('masonry-item1');
 ...
 masonry('#galery1', '.galery-item1', 3)
